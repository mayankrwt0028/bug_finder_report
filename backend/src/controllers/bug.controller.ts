...
import { assignBug, CreateNewBug, deleteBug, getAllBugs, getBugById, updateBug, updateBugStatus } from "../services/bug.service";
...
export const getAllBugscont = async (
  req: AuthRequest,
  res:Response
)=>{
try {
...
export const updateBugCont = async(
  req: AuthRequest,
  res:Response
) =>{
  try {
...
export const updateBugStatusCont = async (
  req:AuthRequest,
  res:Response
)=>{
  try{
...
export const deleteBugCont = async(
  req:AuthRequest,
  res:Response
)=>{
  try {
...
export const getBugByIdCont = async(
  req:AuthRequest,
  res:Response
)=>{
  try {
